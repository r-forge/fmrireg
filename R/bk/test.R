...
flist <- list.files(path, "qt107.*nii")
...
trainruns <- as.integer(seq(1,48, length.out=15))
...
aglm <- afni.glm(fmridesign, "junk", mask="/Users/brad/data1/Dots/KAR/Data_RS/epi/global_mask.nii",options=list(jobs=6))
ret <- build(aglm)
